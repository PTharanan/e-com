...
<head>
    ...
    <title>Page Not Found - {{ config('app.name', 'E-Commerce') }}</title>
...
<body>
    ...
    <div class="error-container">
        {{-- You can replace this src with your exact image path if you save the sample image to public/images --}}
        <img src="{{ asset('images/404-error.png') }}" alt="404 Page Not Found" class="error-image">
