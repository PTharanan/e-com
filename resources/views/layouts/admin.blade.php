...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.returns') }}" title="Returns"
                ...
                <ul class="dropdown-menu" id="settings-dropdown">
                    ...
                    <li class="dropdown-item">
                        <a href="{{ route('admin.currency') }}"
                            class="dropdown-link {{ request()->routeIs('admin.currency') ? 'active' : '' }}">Currency &
                            Rates</a>
                    </li>
                    <li class="dropdown-item">
                        <a href="{{ route('admin.sellers') }}"
                            class="dropdown-link {{ request()->routeIs('admin.sellers') ? 'active' : '' }}">Seller
                            Management</a>
                    </li>
                    <li class="dropdown-item">
            ...
            eventSource.addEventListener('update', (event) => {
                ...
                if (data.stock && data.stock.count !== undefined) {
                    ...
                    if (data.stock.items && data.stock.items.length > 0) {
                        ...
                        data.stock.items.forEach(notif => {
                            html += `
                                <div class="notification-item" id="notif-${notif.id}">
                                    ...
                                    <a href="{{ route('admin.products') }}?search=${notif.product_name}" class="notif-content" style="text-decoration: none; flex: 1;">
                        ...
                        html += `<a href="{{ route('admin.products') }}" class="view-all-link" style="display: block; text-align: center; padding: 10px; font-size: 12px; color: #F59E0B; text-decoration: none; font-weight: 600; border-top: 1px solid #f1f1f1;">View All Products</a>`;
                ...
                if (data.returns && data.returns.count !== undefined) {
                    ...
                    if (data.returns.items && data.returns.items.length > 0) {
                        ...
                        data.returns.items.forEach(notif => {
                            html += `
                                <div class="notification-item" id="notif-${notif.id}">
                                    ...
                                    <a href="{{ route('admin.returns') }}" class="notif-content" style="text-decoration: none; flex: 1;">
                        ...
                        html += `<a href="{{ route('admin.returns') }}" class="view-all-link" style="display: block; text-align: center; padding: 10px; font-size: 12px; color: #6366F1; text-decoration: none; font-weight: 600; border-top: 1px solid #f1f1f1;">View All Returns</a>`;
