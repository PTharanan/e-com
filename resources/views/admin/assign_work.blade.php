...
<div class="page-header">
    ...
    <a href="{{ route('admin.delivery') }}" class="btn-release" style="background: white; border: 1px solid #E2E8F0; color: #64748B; padding: 10px 20px;">Back to Applications</a>
</div>
        ...
        @foreach($deliveryBoys as $boy)
            <div class="partner-card">
                <div class="partner-header">
                    ...
                    <form action="{{ route('admin.delivery.release', $boy->id) }}" method="POST" onsubmit="return confirm('Release this partner? They will be removed from your store.')">
                        @csrf
                        @method('DELETE')
