        ...
        <div class="table-container">
            <table>
                ...
                <tbody id="bannerTableBody">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 40px; color: #64748B;">No banners found. Click
                                "Add Banner" to create one.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <form id="bannerForm" enctype="multipart/form-data">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="image-upload-wrapper">
                        ...
                        <input type="file" name="image" id="banner_image" accept=".jpg,.jpeg,.png,.webp"
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="banner_title" class="form-input" placeholder="e.g. Summer Sale"
                            required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Badge Text</label>
                        <input type="text" name="badge_text" id="banner_badge" class="form-input"
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="subtitle" id="banner_subtitle" class="form-input" rows="3"
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="button_text" id="banner_btn_text" class="form-input"
                            placeholder="Shop Now">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Button Link</label>
                        <input type="text" name="button_link" id="banner_btn_link" class="form-input"
