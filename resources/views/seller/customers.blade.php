    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span style="font-size: 11px; font-weight: 700; text-transform: uppercase; padding: 4px 8px; border-radius: 6px; background: #F1F5F9; color: #64748B;">
                ...
                order.items.forEach(item => {
                    itemsHtml += `
                        <div class="hm-order-item">
                            ...
                            <span class="hm-order-item-price">${currencySymbol}${(item.price * item.qty).toFixed(2)}</span>
                        </div>
                    `;
                });
            }
