...
@section('content')
    <div class="page-header">
        ...
        <div style="display: flex; gap: 15px; align-items: center;">
            <form action="{{ route('seller.products') }}" method="GET" id="searchForm">
                <div class="search-container">
                    ...
                    <input type="text" name="search" id="sellerSearchInput" class="search-input"
                ...
                <div class="step" id="p-step3">
                    <div class="form-group">
                        <label class="form-label" style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <button type="button" onclick="addColorRow()" style="background: var(--admin-primary); color: #fff; border: none; border-radius: 8px; padding: 6px 14px; font-size: 12px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 4px;">+ Add Color</button>
                        </label>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        <label class="form-label" style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <button type="button" onclick="addSizeRow()" style="background: var(--admin-primary); color: #fff; border: none; border-radius: 8px; padding: 6px 14px; font-size: 12px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 4px;">+ Add Size</button>
                        </label>
    ...
    <div class="modal-overlay" id="joinStoreModal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-header" style="text-align: center; margin-bottom: 25px;">
                <div
                    style="width: 60px; height: 60px; background: #FFF1EE; color: var(--admin-primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            if (sessionStorage.getItem('seller_search_focused') === 'true') {
                sessionStorage.removeItem('seller_search_focused');
        ...
        function editProduct(product) {
            ...
            if (product.variants && product.variants.length > 0) {
                product.variants.forEach(v => {
                    if (v.variant_type === 'color') addColorRow(v);
                    else if (v.variant_type === 'size') addSizeRow(v);
                });
            }
