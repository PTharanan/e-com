...
<div class="page-header">
    ...
    <div style="display: flex; gap: 10px;">
        <a href="{{ route('seller.delivery.assign-work') }}" class="btn-action btn-accept" style="text-decoration: none; display: flex; align-items: center; gap: 8px; padding: 12px 20px;">
            ...
            <tr>
                ...
                <td>
                    @if($app->status === 'approved')
                        <form action="{{ route('seller.delivery.update-fee', $app->id) }}" method="POST" style="display: flex; gap: 5px; align-items: center;">
                            @csrf
                            @method('PATCH')
                ...
                <td>
                    <div class="action-btns">
                        ...
                        <form action="{{ route('seller.delivery.status', $app->id) }}" method="POST" id="fire-form-{{ $app->id }}">
                            @csrf
                            @method('PATCH')
